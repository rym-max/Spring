                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" data-val="true" data-val-number="字段 元数据字段 必须是一个数字。" data-val-required="元数据字段 字段是必需的。" id="MetadataFieldId" name="metadataFieldId">
                                    <c:forEach items="${metafield}" var="spiderItem">
                                        <option value="${spiderItem.value}" <c:if test="${spiderItem.value eq rmdf.metadataFieldId}">selected</c:if>>${spiderItem.text}</option>
                                    </c:forEach>
                                </select>
