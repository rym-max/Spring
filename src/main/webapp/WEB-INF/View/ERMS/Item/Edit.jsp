                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" data-val="true" data-val-number="字段 所属频道 必须是一个数字。" data-val-required="所属频道不能为空！" id="ChannelId" name="channelId" onchange="v.search()">
                                    ...
                                    <option value="2" <c:if test="${(!empty item.ownerChannel) and (item.ownerChannel.id eq 1)}">selected</c:if>>论文</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select id="CategoryId" name="categoryId" class="form-control">
                                    ...
                                    <option v-for="(row,index) in data" :value="row.id" :selected="row.id==(index+1)?'selected':''" :style="row.parentId==0?'':'padding-left:20px;'">{{row.name}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
