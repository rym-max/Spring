...
<c:forEach var="item" items="${items}" varStatus="s">
    <c:set var="fieldName" scope="page" value="${item.fieldName}"/>
    <c:set var="values" scope="page" value="${item.values}"/>
    <c:set var="defaultValue" scope="page" value="${item.defaultValue}"/>
    <c:set var="options" scope="page" value="${item.options}"/>
    <div class="form-group">
        <label class="col-sm-2 control-label" for="${fieldName}">${item.name}</label>
        <c:if test="${item.controlType.code ==0}">
            <%--//text--%>
            <c:if test="${!item.isMultiple}">
                <div class="col-sm-10">
        ...
        <c:if test="${item.controlType.code ==1}">
            <%--//multilinetext--%>
            <c:if test="${!item.isMultiple}">
                <div class="col-sm-10">
        ...
        <c:if test="${item.controlType.code ==2}">
            <%--//html--%>
            <div class="col-sm-10">
        ...
        <c:if test="${item.controlType.code ==3}">
            <%--//select--%>
            <div class="col-sm-10">
        ...
        <c:if test="${item.controlType.code ==4}">
            <%--//radio--%>
            <c:forEach items="${options}" var="opt">
        ...
        <c:if test="${item.controlType.code ==5}">
            <%--//checkbox--%>
            <c:forEach items="${options}" var="opt">
        ...
        <c:if test="${item.controlType.code == 6}">
            <%--//datetime--%>
            <div class="col-sm-10">
        ...
        <c:if test="${item.controlType.code == 7}">
            <%--//date--%>
            <div class="col-sm-10">
        ...
        <c:if test="${item.controlType.code <0 || item.controlType.code > 9}">
            <%--//others--%>
            <div class="col-sm-8">
                <input class="form-control" id="${fieldName}" name="${fieldName}" type="text" value="${values[0]}">
            </div>
