            ...
            methods: {
                selectChannel(e, id) {
                    if ($("#channel_id").val() == id) {
                        ...
                        $(".text-navy").removeClass("text-danger");
                        $(e.target).find(".text-navy").addClass("text-danger");
                        $("#channel_id").val(id);
                    }
                    v.search();
                },
                        ...
                        <div class="ibox-content">
                            ...
                            <ul class="category-list">
                                <li v-for="(row,index) in channels">
                                    ...
                                    <a :href="'/ERMS/RelationMetadataField/Create?ChanneId='+row.id" class="btn btn-primary btn-sm pull-right openWindow"><i class="fa fa-plus"></i></a>
