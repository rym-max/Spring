            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="/ERMS/Region/edit" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="NameEN">中文名称</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select data-val="true" data-val-number="字段 所属区域 必须是一个数字。" data-val-required="所属区域 字段是必需的。" id="ParentId" name="parentId" class="form-control">
                                    ...
                                    <option v-for="(row,index) in data" :value="row.id" :selected="row.id==${region.ownerRegion.id}?'selected':''">{{row.name}}</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" data-val="true" data-val-number="字段 前台显示 必须是一个数字。" data-val-required="前台显示 字段是必需的。" id="Map" name="map" type="text" value="${region.map}">
                            </div>
                        </div>
                    </form>
                </div>
