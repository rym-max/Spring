...
public class TestItemService  extends AbstractTestNGSpringContextTests {
...
//        Pagination<Item> pp= new Pagination<Item>(items,searchResult.getNumFound(),page,searchResult.getRows());
//        assertNotNull(pp);
    }
